 ...
 * 添加噪声质量数据
 */
export const  addNoise = data =>fetch('/addNoise',data,'POST');

/**
 * 添加空气质量数据
 */
export const  addAir = data =>fetch('/addAir',data,'POST');

/**
 * 添加水质数据
 */
export const addWater = data =>fetch('/addWater',data,'POST');

/**
 * 获取噪声数据总数
 */
export const getNoiseCount = data => fetch('/noise/count');

/**
 * 获取噪声数据
 */
export const getNoiseList = data => fetch('/noise', data);
/**
 * 获取水质数据
 * @param data
 */

export const getWaterList = data => fetch('/water', data);
/**
 * 获取水质质量数据总条数
 * @param data
 */
export const getWaterCount = data => fetch('/water/count');
 ...
 * @param data
 */
export const getAirList = data => fetch('/air', data);

/**
 * 获取空气质量数据总条数
 * @param data
 */
export const getAirCount = data => fetch('/air/count');
/**
 * 获取用户信息
 */
